                               ...
                               <ul class="nav navbar-nav">
                                    ...
                                    <?php
                                        if(Session::has("username")) {
                                            ...
                                            "<div class = 'form-group'>
                                                <button style = 'margin-left : -15px;background-color: #00CC66' id='logout_btn'class='btn btn-primary'>Logout</button>
                                            </div>";
                                            echo 
                                            "<div class = 'form-group'>
                                ...
                                <form method = "post" action ="{{Asset('search')}}" class = "navbar-form navbar-right">
                                    <div class = "form-group">
                                        ...
                                        <input type = "text" class = "form-control" style ="width: 300px;border-top-right-radius: 0px; border-bottom-right-radius:0px;margin-bottom: 0px" id = "search" name = "keyword" placeholder = "Search coffee place">
                                        
                                    </div>
                                    <div class = "form-group">
                                        <span >
                                             <button style="margin-left: -10px;background-color: #00CC66; border-top-left-radius: 0px; border-bottom-left-radius: 0px;" class = "btn btn-primary"><span class = "glyphicon glyphicon-search"></span></button>  
                                         </span>
                                    </div>
                                    <div class = "form-group">
                                    ...
                                    <div class = "form-group">
                                         ...
                                         <button type="button" style = "background-color: #00CC66" class="btn btn-primary" id="login_btn" data-keyboard="true" data-toggle="modal" data-target="#myModal">Login</button>
                                    </div>   
                                </form>
